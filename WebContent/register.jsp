...
<form action="vodservlet" method="post">
  ...
  <div class="container">
	...
	<input type="radio"name="sex"value="W">W<br><br>
    ...
    <label for="repw"><b>Repeat Password</b></label>
    <input type="password" placeholder="Repeat Password" name="repw" id="repw" required>
